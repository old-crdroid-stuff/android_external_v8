...
def _writeMkpeepholeMakefile(target):
  if target == None:
    raise 'Must specify mkpeephole target properties'
...
def _writeV8SrcMakefile(target):
  if target == None:
    raise 'Must specify v8_base target properties'
...
def _writeGeneratedFilesMakfile(target):
  if target == None:
    raise 'Must specify j2sc target properties'
...
def _writeLibBaseMakefile(target):
  if target == None:
    raise 'Must specify v8_libbase target properties'
